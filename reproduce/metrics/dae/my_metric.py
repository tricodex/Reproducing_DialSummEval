...
dae_data_path = './reproduce/metrics/dae/data_to_eval'
...
def run_eval(input_file, output_file):
    ...
    cmd = '''
        python C:\\Users\\patri\\Desktop\\University\\AI\\combots\\Reproducing_DialSummEval\\reproduce\\metrics\\dae\\eval_my.py \ # change to your path
        --model_type electra_dae \
        --model_dir C:\\Users\\patri\\Desktop\\University\\AI\\combots\\models\\ENT-C_dae \  # change to your model path
        --input_file {} \
        --output_file {} \
